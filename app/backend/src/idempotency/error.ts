...
constructor() {
super('Request body fingerprint does not match the original request for this idempotency key', 409);
}
}

export class AlreadyProcessingError extends IdempotencyError {
constructor() {
super('A request with this idempotency key is already being processed', 409);
}
}